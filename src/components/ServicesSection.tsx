    ...
    <section id="sluzby" className="py-20 px-6 relative overflow-hidden bg-black">
      ...
      <div className="relative z-10 max-w-6xl mx-auto mb-20">
        <div className="text-center mb-16">
          <p className="text-blue-400 uppercase tracking-wide font-medium text-sm mb-4">O NÁS</p>
          <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6">
            DIGITALIZAČNÉ &<br />
            <span className="text-blue-400">AI SLUŽBY</span>
          </h2>
          <p className="text-blue-100 leading-relaxed text-lg max-w-3xl mx-auto mb-8">
      ...
      {/* Services Grid with Photo */}
      <div className="relative z-10 max-w-6xl mx-auto">
        {/* Photo positioned above services blocks */}
        <div className="flex justify-center mb-0 relative z-20">
          <div className="w-80 h-[500px] bg-gradient-to-br from-slate-800 to-slate-900 rounded-t-2xl border-2 border-dashed border-blue-500/30 flex items-center justify-center shadow-2xl">
