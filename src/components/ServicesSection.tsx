  ...
  return <section id="sluzby" className="py-20 px-6 relative overflow-hidden bg-black">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8">
          {/* Service 1 */}
          <div className="group bg-gradient-to-br from-blue-400/20 to-blue-500/20 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-white/30 hover:from-blue-400/30 hover:to-blue-500/30 transition-all duration-300 hover:scale-105 hover:shadow-xl min-h-80">
